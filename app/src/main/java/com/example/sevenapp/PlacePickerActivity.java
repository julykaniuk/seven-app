...
public class PlacePickerActivity extends AppCompatActivity implements OnMapReadyCallback, ConfirmAddress.Selected {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Отримання посилання на SupportMapFragment
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map);
        // Перевірка на нульовий об'єкт
        if (mapFragment != null) {
            // Виклик методу getMapAsync з власним екземпляром OnMapReadyCallback
            mapFragment.getMapAsync(this);
        }
        // Перевірка наявності дозволу на доступ до місцезнаходження
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed(); // Додайте цей виклик
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            ...
            default:
                super.onRequestPermissionsResult(requestCode, permissions, grantResults); // Додайте цей виклик
        }
    }
    ...
    public void mapListener() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
            ...
            // Дозвіл на доступ до місцезнаходження не наданий, обробіть це відповідним чином
        }
